...
class Question extends Component{
    ...
    render(){
        ...
        <div className="question">
            <h5>Q: {this.props.obj.question}</h5>
            <h6>Question by: {this.props.obj.asker}</h6>
            <div>{this.answerList()}</div>
            {/* <p>date: {this.props.obj.date}</p> */}
            {
            !this.state.allowanswers ?  <></> : 
            <div> 
            <label htmlFor="answer"></label>
            <input type="text" id="answer" value = {this.state.answer} onChange={this.handleAnswer}/>
            <input type="submit" value="Submit your Answer" onClick={this.onSubmit}/>
            </div>
            }
        </div>)
    }
...
export default class Answersquest extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userValidToken: 0,
...
//                     <div>
//                         {/* <input type="button" id='back-home' value='Back to Home' onClick={this.goGackHome} />
//                         <h2>Answers questions of others</h2> */}
